...
Το εργαστήριο του po/iw είναι ένας ανοικτός χώρος που μπορεί κάθε άτομο να υλοποιήσει κάποια ιδέα που έχει, χρησιμοποιώντας τα αναλώσιμα και τον εξοπλισμό που παρέχονται.
  ...
  },
  {
    ...
    description: (
      <>
        Στοχεύουμε για ένα ποιοτικό χώρο διά βίου μάθησης, όπου οι φοιτητές και φοιτήτριες μέλη ανταλλάσσουν ιδέες &amp; απορίες.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Κάτω από την ομπρέλα του po/iw υπάγονται projects και εκδηλώσεις με σκοπό την διάδοση της κουλτούρας του ανοικτού και ελεύθερου λογισμικού και υλισμικού.
      </>
    ),
  },
];
